# 🍽️ Proyecto Web Gourmet - Pepe Vieira (La Última Cocina del Mundo)
...
* **URL del Repositorio Público:** [Inserta aquí el enlace a tu repositorio, ej: https://github.com/usuario/repo]
* **URL de la Página en Producción:** [Inserta aquí tu enlace de GitHub Pages, ej: https://usuario.github.io/repo/]

>  **Nota de Despliegue:** Debido a la estructura organizada del proyecto por módulos y carpetas (`Pagina_Aterrizage/`, `Pagina_De_Busqueda/`, etc.), se ha implementado un archivo puente `index.html` en la raíz del repositorio que gestiona una redirección instantánea mediante meta-refresh de 0 segundos, garantizando que GitHub Pages cargue correctamente la landing principal sin romper las rutas relativas de las imágenes (`../img/`) ni de las hojas de estilos CSS.
...
1. **Carrito Persistente Multi-página:** Permite añadir productos en la tienda, actualizar las burbujas (*badges*) notificadoras al instante y consultar el desglose total del dinero (con cálculos dinámicos de IVA del 10% en la ficha de compra) desde cualquier sección de la web.
2. **Sistema de Confirmación de Borrado:** El botón de eliminación del carrito intercepta la acción del usuario abriendo un modal nativo de Bootstrap para confirmar la remoción del elemento de forma segura mediante métodos de la clase `ShoppingCart`.
...
![Captura de pantalla de la auditoría de Lighthouse](../Iconos/Opiniones.png) *(Reemplaza esta imagen por tu captura real)*
